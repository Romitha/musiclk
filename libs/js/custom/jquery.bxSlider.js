...
(function (a) {
    a.fn.bxSlider = function (b) {
        ...
        function H() {
            I(b.startingSlide);
            if (b.mode == "horizontal") {
                e.wrap('<div class="' + b.wrapperClass + '" style=" position:relative; overflow: hidden;margin: 0;"></div>').wrap('<div class="bx-window" style="position:relative; overflow:hidden; margin: 0;"></div>').css({
                    width: "999999px",
